...
export default function AdminLayout() {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen name="monitor" options={{ title: "Monitor", tabBarIcon: ({ color, size }) => <Ionicons name="pulse" size={size} color={color} /> }} />
      <Tabs.Screen name="attendance" options={{ title: "Attendance", tabBarIcon: ({ color, size }) => <Ionicons name="finger-print" size={size} color={color} /> }} />
